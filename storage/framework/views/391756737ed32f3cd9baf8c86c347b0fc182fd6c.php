	...
	<div class="row">
		...
		<div class="form-group">
			...
			<div class="form-group col-md-6">
				<input class="form-control" type="text" name="kode_lembur" value="<?php echo e($kategoril->kode_lembur); ?>" required="">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="form-group col-md-6">
				<input class="form-control" type="text" name="besaran_uang" value="<?php echo e($kategoril->besaran_uang); ?>" required="">
			</div>
		</div>
