...
<div class="container">
	<div class="row">
		...
		<form method="POST" action="<?php echo e(route('lembur-pegawai.update', $lpegawai->id)); ?>">
		...
		<div class="form-group">
			...
			<div class="form-group col-md-6">
				<input class="form-control" type="text" name="jumlah_jam" value="<?php echo e($lpegawai->jumlah_jam); ?>">
			</div>
		</div>
